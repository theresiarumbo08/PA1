...
<div class="card mt-5">
    <div class="card-body">
          <h3><i class="fas fa-user-graduate mr-2"></i>Data Mahasiswa</i></h3><hr>
          
          <a href="editData.php" class="btn btn-primary mb-4"><i class="fas fa-plus-square ml-2 p-2"></i>Edit Data Mahasiswa</a>
          <div class="card mt-5">
                <div class="card-body">
               <tbody>
