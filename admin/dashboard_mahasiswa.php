...
?>
        ...
        <div class="col-md-10 p-5 pt-2">
          <h3><i class="fas fa-user-graduate mr-2"></i>Daftar Akun Mahasiswa</i></h3><hr>
          
          <a href="pendaftaran.php" class="btn btn-primary mb-4"><i class="fas fa-plus-square ml-2 p-2"></i>Tambah Akun Mahasiswa</a>
